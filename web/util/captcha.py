...
fontType = "{}{}resources/font/ARIALN.TTF".format(web["pic_read"], web["pic_pix"])

color_list = [(0, 0, 0), (255, 0, 0), (255, 0, 255), (0, 255, 0), (0, 0, 255)]
...
if __name__ == "__main__":
    code_img = create_validate_code(length=4)
    code_img[0].save("g:/validate9.png")
    print(code_img[1])
